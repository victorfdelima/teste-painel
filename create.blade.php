    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.user.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    <label for="last_name" class="col-xs-12 col-form-label">CPF ou CNPJ</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('cpf_cnpj') }}" name="cpf_cnpj" required id="cpf_cnpj" placeholder="CPF ou CNPJ">
                    </div>
                </div>
