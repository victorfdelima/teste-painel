    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="container rounded-sm bg-white  py-3 shadow-sm">
                    <div class="row no-margin">
                        <div class="col-md-12">
                            <h4 class="page-title">@lang('Minhas Entregas Solicitadas')</h4>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-condensed" style="border-collapse:collapse;">
                                ...
                                <tbody>
                                    ...
                                    <tr data-toggle="collapse" data-target="#trip_{{$trip->id}}" class="accordion-toggle collapsed" style="cursor:pointer">
                                    ...
                                    <tr class="hiddenRow">
                                        <td colspan="12">
                                            <div class="accordian-body collapse row" id="trip_{{$trip->id}}">
                                                ...
                                                <div class="col-md-6 text-wrap">
                                                    <button id="{{$trip->id}}" class="btn btn-warning rounded-sm mb-4 float-right" value="{{$trip->id}}">Reclamar</button>
                                                    ...
                                                    <div class="fare-break">
                                                        ...
                                                        <h5 class="my-3">@lang('user.ride.minutes_price'): <span>
                                                                @if($trip->payment)
                                                        ...
                                                        <h5 class="my-3">@lang('user.ride.hours_price'): <span>
                                                                @if($trip->payment)
                                                        ...
                                                        <h5 class="my-3">@lang('user.ride.distance_price'): <span>
                                                                @if($trip->payment)
                                                        ...
                                                        <h5 class="my-3">@lang('user.ride.wallet_deduction'): <span>
                                                        ...
                                                        <h5 class="my-3">@lang('user.ride.promotion_applied'): <span>
                                                        ...
                                                        <h5 class="my-3"><strong>@lang('user.ride.waiting_price'): </strong><span><strong>
                                                                    {{currency($trip->payment->waiting_amount)}}
                                                                </strong></span></h5>
                                                        @endif

                                                        @if($trip->payment->round_of)
                                                        <h5 class="my-3"><strong>@lang('user.ride.round_off'): </strong><span><strong>
                                                                    {{currency($trip->payment->round_of)}}
                                                                </strong></span></h5>
                                                        @endif

                                                        <h5><strong>@lang('Total') - {{$trip->payment_mode}} </strong><span><strong>
                                                                    @if($trip->payment)
                                                                    @if($trip->payment_mode=='Dinheiro')
                    ...
                    if (data.sendBtn == "yes") {
                        ...
                        $("#lostitemMsgBody").empty()
                            ...
                            <div class="col-xs-3">
                                ...
                                <div class="col-xs-7">    
                                <textarea class="dispdesc" name="msg" id="lostitemMsg" placeholder="Escreva sua mensagem"></textarea>
                            </div>
                            </div>
                ...
                if (data.dispute.length != 0 && typeof(data.dispute) !== "undefined" && data.dispute != null) {
                    ...
                    if (data.sendBtn == "yes") {
                        ...
                        if (disputeMsgBody != "false") {
                            $("#disputeMsgBody").empty()
                             ...
                             <div class="col-xs-7">    
                             <textarea class="dispdesc" name="msg" id="disputeMsg" placeholder="Escreva sua mensagem"></textarea>
                             </div>
                             </div>
                    ...
                    $("#disputeBody").empty()
                        .append(` <div class="row dis">
                            ...
                            <div class="col-xs-7">
                            <input type="text" class="disptitle" id="disputeTitle" name="title" placeholder="Adicione um titulo"/>
                            </div>
                        </div>`);
                    $("#disputeReason").empty();
                    ...
                    $("#disputeReason").append('<option value="others">Outros</option>');
                    $("#disputeMsgBody").empty()
