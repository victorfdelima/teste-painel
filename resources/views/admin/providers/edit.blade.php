              ...
              <div class="form-group row">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $provider->link_picpay }}" name="link_picpay"  placeholder="Conta picpy">
                    </div>
                </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $provider->link_mp }}" name="link_mp"  placeholder="Conta mercado pago">
                    </div>
                </div>
               ...
               <!-- <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                     <h2 class="bg-info">({{ $provider->referral_unique_id }})</h2>
                  </div>
                </div>-->
              <div class="form-group row">
