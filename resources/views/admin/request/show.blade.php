            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dt class="col-sm-4">@lang('admin.request.tipo_corrida')</dt>
                        <dd class="col-sm-8"> @if($request->is_instant_ride !='1')
                         NORMAL
                        @else
                         AVULSA
                        @endif
                       ...
                       <!--  <dt class="col-sm-4">@lang('admin.request.surge_price') :</dt>
                        ...
                        <dd class="col-sm-8">
                            ...
                            @elseif($request->payment_mode == "DEBIT_MACHINE")
                                DÉBITO MÁQUINA
                            @elseif($request->payment_mode == "PIC_PAY")
                                PIC PAY
                                @elseif($request->payment_mode == "M_P")
                                MERCADO PAGO
