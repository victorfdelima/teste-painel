                                ...
                                <div class="accordian-body collapse row" id="trip_{{$trip->id}}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mytrip-right">
                                            <div class="whlbtn">
                                <button id="{{$trip->id}}" class="dispute" value="{{$trip->id}}">Reclamar</button>
                                <!--<button id="{{$trip->id}}" class="lostitem" value="{{$trip->id}}">LostItem</button>!-->
                                            ...
                                            <div class="fare-break">
                                                ...
                                                @if($trip->payment)
                                                    ...
                                                    @endif
                                                @endif
                                               <!-- <h5><strong>@lang('32323') </strong><span><strong>
                                                @if($trip->payment)
                                                ...
                                                <h5 class="big"><strong>@lang('Total') - {{$trip->payment_mode}} </strong><span><strong>
                                                @if($trip->payment)
