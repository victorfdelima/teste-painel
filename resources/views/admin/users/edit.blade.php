    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <h5 style="margin-bottom: 2em;">Atualizar informações</h5>
                
                <!--caminho para alterar app\Http\Controllers\Resource -->
                ...
                <form class="form-horizontal" action="{{route('admin.user.update', $user->id )}}" method="POST"
                    ...
                    <div class="form-group row">
                        <label for="last_name" class="col-xs-2 col-form-label">Sobre nome</label>
                        <div class="col-xs-10">
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        <label for="last_name" class="col-xs-2 col-form-label">Valor na Carteira R$</label>
                        <div class="col-xs-10">
                          <input class="form-control" type="text"    value= "{{ $user->wallet_balance }}" data-decimal="," name="wallet_balance" required id="wallet_balance" placeholder="CARTEIRA">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="last_name" class="col-xs-2 col-form-label">Valor base</label>
                        <div class="col-xs-10">
                          <input class="form-control" type="text" value= "{{ $user->base_value }}" data-decimal="," name="base_value" required id="base_value" placeholder="valor base">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <!--<div class="form-group row">
                        <label for="country_code"
                               class="col-xs-2 col-form-label">Codigo Pais</label>
                        <div class="col-xs-10">
