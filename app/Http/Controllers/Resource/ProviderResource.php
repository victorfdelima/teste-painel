...
class ProviderResource extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $provider->cpf_cnpj = $request->cpf_cnpj;
			$provider->link_picpay = $request->link_picpay;
			$provider->link_mp = $request->link_mp;
            $provider->country_code = "55";
