                ...
                <form id="form-create-ride" onSubmit={this.createRide.bind(this)} method="POST" autoComplete="off">
                    <div className="row">
                        ...
                        <div className="col-xs-12">
                            <div className="form-group">
                                <label htmlFor="s_address">LOCAL DE EMBARQUE</label>
                            ...
                            <div className="form-group">
                                <label htmlFor="d_address">LOCAL DESEMBARQUE</label>
                            ...
                            <div className="form-group">
                                <label htmlFor="estimated" className="estimate_amount">Quantidade estimada :  <span id="estimated">R$0</span></label>
                            </div>
                            <div className="form-group">
                                <label htmlFor="provider_auto_assign">Escolher Motorista automática</label>
                                <br />
                        ...
                        <a className="text-black" href="#">
                            <div className="media">
                                <div className="media-body">
                                    ...
                                    <h6 className="media-heading">TIPO DE SERVIÇO: {provider.service.service_type.name}</h6>
                                </div>
                            </div>
                        </a>
                    </div>
