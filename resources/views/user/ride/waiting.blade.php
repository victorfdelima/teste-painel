			...
			<div class="col-md-6">
				...
				<div class="user-request-map">
					...
					if($request->paradas != null)
						$paradas = unserialize($request->paradas);

					$map_icon = asset('asset/img/marker-start.png');
						//$static_map = "https://maps.googleapis.com/maps/api/staticmap?autoscale=1&size=600x450&maptype=roadmap&format=png&visual_refresh=true&markers=icon:".$map_icon."%7C".$request->s_latitude.",".$request->s_longitude."&markers=icon:".$map_icon."%7C".$request->d_latitude.",".$request->d_longitude."$paramParada&path=color:0x191919|weight:8|enc:".$request->route_key."&key=".Config::get('constants.map_key'); 
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="modal-footer">
						<button type="button" class="full-primary-btn locchange" style="background-color:#ff5e00; border-radius: 40px;">Submit</button>
					</div>
				</form>
			</div>
		</div>
...
//Para melhorar Status e botão de cancelar corrida painel //TODO FRONT
