...
<div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="row no-margin">
            <div class="col-md-12">
                <h3  class="font-weight-bold">@lang('user.payment')</h3>
            </div>
        </div>
        @include('common.notify')
        <div class="row no-margin payment mt-4">
            <div class="col-md-12">
                ...
                @if(Auth::user()->cpf_cnpj && strlen(preg_replace('/\D/m', '', Auth::user()->cpf_cnpj)) === 14) <div class="pay-option">
                    <h6><img src="{{asset('asset/img/cash-icon.png')}}"> @lang('user.contract') </h6>
                </div>
                @endif
                @if(config('constants.card') == 1)
