...
function initialize(latitude = 0, longitude = 0) {
    ...
    var mapInterval = setInterval(getProviders, 1000);
    ...
    function showinfoWindow(marker) {
        ...
        var html = `<table>
                        <tbody>
                                ...
                                <tr><td>&nbsp;&nbsp;whats: </td><td><b>Chamar<a href='https://api.whatsapp.com/send?phone=55` + marker.provider.mobile + `&text=Oi%20Motorista'>` + marker.provider.mobile + `</a>` + live_tarack +`</tbody>
                </table>`;
