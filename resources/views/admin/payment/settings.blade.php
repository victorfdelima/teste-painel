                ...
                <div class="card card-block card-inverse card-primary">
                    ...
                    <i class="fa fa-3x fa-credit-card pull-right"></i>
                       <div class="form-group row">
                            ...
                            <div class="col-xs-6">
                                <input @if(config('constants.pic_pay') == 1) checked  @endif autocomplete="off" name="pic_pay" id="pic_pay" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                        </div>
                    </blockquote>
                </div><!-- PICPAY-->
                ...
                <div class="card card-block card-inverse card-primary">
                    ...
                    <i class="fa fa-3x fa-credit-card pull-right"></i>
                       <div class="form-group row">
                            ...
                            <div class="col-xs-6">
                                <input @if(config('constants.mercado_pago') == 1) checked  @endif autocomplete="off" name="mercado_pago" id="mercado_pago" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                        </div>
                    </blockquote>
                </div><!-- PICPAY-->
