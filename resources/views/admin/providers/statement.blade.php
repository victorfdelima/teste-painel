                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="box box-block bg-white tile tile-1 mb-2"  style="border-top-color: #3e70c9 !important;">
                        ...
                        <div class="t-content">
                            ...
                            <i class="fa fa-caret-up text-success mr-0-5"></i><span>Viagens Solicitadas</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box box-block bg-white tile tile-1 mb-2" style="border-top-color: #f44236 !important;">
                        ...
                        <div class="t-content">
                          <h6 class="text-uppercase mb-1"></h6>
                            <h2 class="mb-1">VIAGENS CONCLUIDAS</h2>
                            <h1 class="mb-1">{{$total}}</h1>
                           
                            <i class="fa fa-caret-down text-danger mr-0-5"></i><span><h6 class="text-uppercase mb-1">@lang('admin.dashboard.Revenue')</h6>
                            Total de KM até o momento<h3 class="mb-1">{{($cancel_rides)}}</h3></span>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-bordered dataTable" id="table-4">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('admin.request.tipo_corrida')</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($ride->payment_mode == "DEBIT_MACHINE")
                                                DÉBITO MÁQUINA
                                            @elseif($ride->payment_mode == "PIC_PAY")
                                                PIC PAY
                                            @elseif($ride->payment_mode == "M_P")
                                                MERCADO PAGO
